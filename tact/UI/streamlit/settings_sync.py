...
def write_settings():
    ...
    if isinstance(st.session_state.headerValuesToReplace, str):
        print(st.session_state.headerValuesToReplace)
        config_to_apply["headerValuesToReplace"] = json.load(
            st.session_state.headerValuesToReplace
        )
